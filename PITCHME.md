...
на усмотрение автора (к примеру: целевой сайт, порт прокси и т.п.)
...
Пример подобного: https://twitter.com/mashomatic
