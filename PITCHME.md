...
@css[justified](Приложение позволяющее отправить через веб-форму некоторый текст, выдающее на
его основе набор комбинаций сформированных через марковские цепи.)

@css[justified](**Hard mode**: исходные данные и результирующие комбинации должны храниться в
