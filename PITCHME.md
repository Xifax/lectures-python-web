...
- Написание тестов позволяет сформировать исходные требования к алгоритмам и логике
нашего кода
...
- Как и в случае с blueprint'ами Flask'а, можно выделять компоненты в отдельные приложения
...
особенно в сравнении с другими фреймворками
...
- По сути представляет собой готовую вариацию на тему готовой совокупности других модулей,
вроде Flask + Connexion + Cerberus + DB Backend
...
- Хорошо подходит для разнообразных фоновых сервисов предполагающих высокое
