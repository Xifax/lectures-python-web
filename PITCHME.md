...
---?code=src/flask/6-form.py&lang=py&color=white&title=Flask. Form
...
---?code=src/flask/templates/form.html&lang=html&color=white&title=Flask. Form. Template
@[1](Наследуем от главного шаблона)
@[3-8](Контент: наша форма)
@[13-17](Подпись для нашего конкретного POST запроса)
