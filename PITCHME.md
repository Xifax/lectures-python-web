...
@[41-43](Сбрасываем количество просмотров и перенаправляем пользователя)
@[44, 46](Возвращаем результаты вызова функции и отдекорированную функцию)
@[48-51](Обернём наш маршрут)
...
---?code=src/flask/templates/san-juan.html&lang=html&color=white&title=Another template
