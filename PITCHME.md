...
Приложение, позволяющее отправить через веб-форму некоторый текст. После успешного сабмита выдающее на
основе этого текста набор комбинаций, сформированных через марковские цепи.
